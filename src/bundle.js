(function (global, factory) {
	...
	*/
	...
	var PortalsComponent = function (_React$Component) {
	  inherits(PortalsComponent, _React$Component);

	  function PortalsComponent(props) {
	    classCallCheck(this, PortalsComponent);

	    var _this = possibleConstructorReturn(this, _React$Component.call(this, props));

	    _this.el = document.createElement(_this.props.dom);
	    _this.portalDom = document.querySelector(_this.props.el);
	    return _this;
	  }

	  PortalsComponent.prototype.componentDidMount = function componentDidMount() {
	    this.portalDom.appendChild(this.el);
	  };

	  PortalsComponent.prototype.render = function render() {
